...
@Data
public class F0200400Dto implements BaseMessage{
	...
	@FixedString(order = 9, type = MessageFieldType.NUMERIC, value = 3)
	private String bankCode;
	@FixedString(order = 10, type = MessageFieldType.ALPHABET, value = 15)
	private String acnutNo;
	@FixedString(order = 11, type = MessageFieldType.ALPHABET, value = 3)
	private String irSafSe;
	@FixedString(order = 12, type = MessageFieldType.NUMERIC, value = 9)
	private String fee;
	...
	@FixedString(order = 17, type = MessageFieldType.ALPHABET, value = 14)
	...
	@FixedString(order = 21, type = MessageFieldType.ALPHABET, value = 15)
	private String agremSn;
	@FixedString(order = 22, type = MessageFieldType.ALPHABET, value = 3)
	private String pmsId;
	@FixedString(order = 23, type = MessageFieldType.ALPHABET, value = 20)
	private String agremInsttId;
	@FixedString(order = 24, type = MessageFieldType.ALPHABET, value = 22)
