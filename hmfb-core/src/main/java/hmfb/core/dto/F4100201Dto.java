 ...
 */
@Data
public class F4100201Dto implements BaseMessage{
	...
	@FixedString(order = 18, type = MessageFieldType.ALPHABET, value = 13)
	private String csrcc; 			// 자기앞
	@FixedString(order = 19, type = MessageFieldType.ALPHABET, value = 13)
	private String prsnlchk; 		// 가계
	@FixedString(order = 20, type = MessageFieldType.NUMERIC, value = 34)
