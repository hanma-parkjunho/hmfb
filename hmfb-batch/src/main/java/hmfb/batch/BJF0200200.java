 ...
 */
@Log4j2
public class BJF0200200 implements IChunkBatchJob {
...
//		DB 조회 조건을 입력
	 ...
	 */
	@Override
	public T0200200Dto process(Object param, BatchJobContext ctx) throws HmfbException {

		T0200200Dto input = (T0200200Dto)param;
		T0200200Dto output = new T0200200Dto();
		
		F0200200Dto inFirmDto = new F0200200Dto();
		...
		inFirmDto.setSalaryTransfrSe(input.getSalaryTransfrSe());           //급여이체 구분
		...
		FirmReturnDto returnDto = F0200200Service.getService(F0200200Service.class).f0200200Service(inFirmDto, input.getTelemsgNo());
		F0200200Dto outFirmDto = (F0200200Dto) returnDto.getRtnObj();
		...
		output.setSendYn("Y");
		BatchDao.getDao().update("T0200200.updateT0200200", output);
		if (log.isDebugEnabled()) {
			log.debug("F0200200 전문 응답 처리 완료");
