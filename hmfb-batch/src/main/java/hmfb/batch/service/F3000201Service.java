...
public class F3000201Service extends AbstractBatchService {
     ...
     * @throws Exception
     */
    public FirmReturnDto f3000201Service (F3000201Dto dto, String telemsgNo) {
    	// 송신 호출
    	FirmReturnDto rtnDto = intfService.sendTcp(InterfaceMapping.INF_FIRM_26, dto, telemsgNo);
