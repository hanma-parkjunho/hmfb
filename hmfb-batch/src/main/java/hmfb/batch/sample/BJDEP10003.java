 ...
 * OUTPUT 데이터 : /springbank/src/test/resources/output/files/export_account_YYYYMMDD.csv  => 일자별 파일명이 변경되는 경우. 
 * 
 * @author KDK
 *
 */
public class BJDEP10003 implements IChunkBatchJob {
...
//		파일 IO 주입
		...
		ioMeta.setFileType(BatchConstants.FILE_TYPE_DELIM);
		ioMeta.setDelimeter(BatchConstants.DELIM_COMMA);
		
		ioMeta.setOutputAttributeNames(new String[] {"accountNo","productCode","cifNo","balance","openDate","status"});
//		ioMeta.setOutputLineFormat("%1s);
