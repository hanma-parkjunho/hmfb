 ...
 * 샘플코드에서 사용한 데이터 예시
 * ------------------------------------
 * 배치 유형      : F2D( fixed flat file )
 * INPUT 데이터  : /springbank/src/test/resources/input/files/fwtest_YYYYMMDD.sam  => 일자별 파일명이 변경되는 경우.
 * OUTPUT 데이터 : TDEP10001.openAccount 
 * 
 * @author kmk
 *
 */
public class BJDEP10002 implements IChunkBatchJob {
...
//		항목별 {start, end} 배열. 1부터 시작
		...
		ioMeta.setInputFixedLenInfo(ranges);
